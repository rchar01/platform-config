...
| Staged `openbao` role | `openbao_firewalld_manage`, `openbao_backend_allowed_sources`, canonical cluster members | Reconciled direct-backend and peer-only cluster rules through the guarded, disabled-service staging playbook. |
