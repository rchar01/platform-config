...
- `openbao`: retired standalone OpenBao implementation retained temporarily while its three-node HA replacement is developed. No active playbook invokes it; do not apply it to the `openbao` group.
